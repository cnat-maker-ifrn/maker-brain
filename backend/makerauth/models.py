...
class UserManager(BaseUserManager):
    def create_user(self, cpf, email, name, cellphone, bond, enrollment=None, password=None, **extra_fields):
    ...
    def create_superuser(self, cpf, email, name, cellphone, bond='public_servant', enrollment=None, password=None, **extra_fields):
