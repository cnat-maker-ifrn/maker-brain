...
import { useUserProfile, EditProfileModal } from '@/features/makerauth';
import {
  useMyVisits,
  useMyServices,
  VisitCard,
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5">
          ...
          <div className="flex items-center gap-3 self-end sm:self-center">
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-md border border-gray-300 bg-white px-3.5 py-2 text-sm font-semibold text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-forest-500 focus:ring-offset-2 transition-colors"
            >
